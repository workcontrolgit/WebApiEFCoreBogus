...
namespace OnionApiUpgradeBogus.Application.Features.Employees.Queries.GetEmployees
{
    /// <summary>
    ...
    public class GetAllEmployeesQueryHandler : IRequestHandler<GetEmployeesQuery, PagedResponse<IEnumerable<Entity>>>
    {
        ...
        /// </returns>
        public GetAllEmployeesQueryHandler(IEmployeeRepositoryAsync repository, IMapper mapper, IModelHelper modelHelper)
        {
        ...
        public async Task<PagedResponse<IEnumerable<Entity>>> Handle(GetEmployeesQuery request, CancellationToken cancellationToken)
        {
            ...
            var entityEmployees = await _repository.GetPagedEmployeeResponseAsync(validFilter);
